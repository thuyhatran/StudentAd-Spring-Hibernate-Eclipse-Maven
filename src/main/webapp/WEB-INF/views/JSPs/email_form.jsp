...
<html>
    <head>
        ...
        <title>Email</title>
        <style type="text/css"> <%@include file="/WEB-INF/views/CSSs/email_form.css" %></style>
        <%-- <link rel="stylesheet" type="text/css" href="<c:url value="/WEB-INF/views/CSSs/email_form.css"/>"> --%>
    </head>
    <body>
